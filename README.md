...
## 好的内容应该得到广泛的传播和关注；不好的价值观不对的内容，更应该得到广泛的批判；把内容放到版权©️这个金丝笼里不利于互联网传播
...
感谢 [Shapooo/WeiBack](https://github.com/Shapooo/WeiBack) 项目提供微博备份能力。本归档的原始 HTML 和媒体文件来自 WeiBack 导出的本地备份，后续整理、索引和静态网页展示均建立在这份备份结果之上。
